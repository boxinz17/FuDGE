...
################################ Model 1 #######################################################
FuDGE.result.path <- ""  # FuDGE result for model1 path
...
for (p in p.v){
  ...
  ROC_list <- list()
  for (i in 1:M){
    load(paste(FuDGE.result.path, "/Para_result_p", p, "_runind", i, ".RData", sep=""))
...
################################ Model 2 #######################################################
FuDGE.result.path <- ""  # FuDGE result for model2 path
...
################################ Model 3 #######################################################
FuDGE.result.path <- ""  # FuDGE result for model3 path
