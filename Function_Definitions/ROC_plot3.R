ROC_plot3 <- function(cov.X, cov.Y, TrueMat, p, M, lambdamax=2, lambdamin=0, steplength=0.1){
  ...
  lambda.candidates <- seq(lambdamin, lambdamax, steplength)
  ...
  return(list(TPR=TPR.record, FPR=FPR.record, num.iter=k))
}
